     ...
     *
        ...
        if (! dtSettings._bInitComplete ) {
            dtSettings.oApi._fnCallbackReg(
                dtSettings, 'aoInitComplete', function () {
            ...
            * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
            ...
            "_fnConstruct": function ( oInit ) {
                ...
                if (typeof this.s.dt.oInstance.fnVersionCheck != 'function' 
                    ...
                    alert(
                        "FixedColumns "+FixedColumns.VERSION+" required DataTables 1.8.0 or later. "+
                ...
                if (this.s.dt.oScroll.sX === "" ) {
                    this.s.dt.oInstance.oApi._fnLog(
                        this.s.dt, 1, "FixedColumns is not needed (no "+
                ...
                $(this.s.dt.nTableWrapper).on(
                    'mousedown.DTFC', function (e) {
                        if (e.button === 0 ) {
                            mouseDown = true;
                ...
                $(this.dom.scroller)
                .on(
                    'mouseover.DTFC touchstart.DTFC', function () {
                        if (! mouseDown ) {
                ...
                .on(
                    'column-sizing.dt.DTFC', function () {
                        that._fnColCalc();
                        that._fnGridLayout(that);
                    } 
                )
                .on(
                    'column-visibility.dt.DTFC', function ( e, settings, column, vis, recalc ) {
                ...
                .on(
                    'select.dt.DTFC deselect.dt.DTFC', function ( e, dt, type, indexes ) {
                        if (e.namespace === 'dt' ) {
                               that._fnDraw(false);
                        }
                    } 
            ...
            "_fnColCalc": function () {
                ...
                $.each(
                    this.s.dt.aoColumns, function (i, col) {
                        var th = $(col.nTh);
                        var border;
 ...
 *
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    DataTable.Api.register(
        'fixedColumns().relayout()', function () {
            return this.iterator(
                'table', function ( ctx ) {
                    if (ctx._oFixedColumns ) {
    ...
    DataTable.Api.register(
        'fixedColumns().rowIndex()', function ( row ) {
            row = $(row);
    ...
    DataTable.Api.register(
        'fixedColumns().cellIndex()', function ( cell ) {
            cell = $(cell);
    ...
    DataTable.Api.registerPlural(
        'cells().fixedNodes()', 'cell().fixedNode()', function () {
            return this.iterator(
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    $(document).on(
        'init.dt.fixedColumns', function (e, settings) {
            if (e.namespace !== 'dt' ) {
                return;
            }
