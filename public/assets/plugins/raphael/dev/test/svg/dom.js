(function (assert) {
    ...
    QUnit.test(
        'insertBefore: no element', function (assert) {
            const el = paper.rect();
    ...
    QUnit.test(
        'insertBefore: first element', function (assert) {
            const x = paper.rect();
            const el = paper.rect();
    ...
    QUnit.test(
        'insertBefore: middle element', function (assert) {
            const x = paper.rect();
            const y = paper.rect();
            const el = paper.rect();
    ...
    QUnit.test(
        'insertBefore: no element when wrapped in <a>', function (assert) {
    ...
    QUnit.test(
        'insertBefore: first element when wrapped in <a>', function (assert) {
            const x = paper.rect();
            const el = paper.rect().attr('href', url),
            anchor = el.node.parentNode;
    ...
    QUnit.test(
        'insertBefore: first element wrapped in <a> and wrapped in <a>', function (assert) {
    ...
    QUnit.test(
        'insertBefore: middle element when wrapped in <a>', function (assert) {
            const x = paper.rect();
            const y = paper.rect();
            const el = paper.rect().attr('href', url),
            anchor = el.node.parentNode;
    ...
    QUnit.test(
        'insertBefore: middle element wrapped in <a> and wrapped in <a>', function (assert) {
            const x = paper.rect().attr('href', url),
            xAnchor = x.node.parentNode;
    ...
    QUnit.test(
        'insertAfter: no element', function (assert) {
            const el = paper.rect();
    ...
    QUnit.test(
        'insertAfter: last element', function (assert) {
            const x = paper.rect();
            const el = paper.rect();
    ...
    QUnit.test(
        'insertAfter: middle element', function (assert) {
            const x = paper.rect();
            const y = paper.rect();
            const el = paper.rect();
    ...
    QUnit.test(
        'insertAfter: no element when wrapped in <a>', function (assert) {
            const el = paper.rect().attr('href', url),
            anchor = el.node.parentNode;
    ...
    QUnit.test(
        'insertAfter: last element when wrapped in <a>', function (assert) {
            const x = paper.rect();
            const el = paper.rect().attr('href', url),
            anchor = el.node.parentNode;
    ...
    QUnit.test(
        'insertAfter: last element wrapped in <a> and wrapped in <a>', function (assert) {
            const x = paper.rect().attr('href', url),
            xAnchor = x.node.parentNode;
            const el = paper.rect().attr('href', url),
            anchor = el.node.parentNode;
    ...
    QUnit.test(
        'insertAfter: middle element when wrapped in <a>', function (assert) {
            const x = paper.rect();
            const y = paper.rect();
            const el = paper.rect().attr('href', url),
            anchor = el.node.parentNode;
    ...
    QUnit.test(
        'insertAfter: middle element wrapped in <a> and wrapped in <a>', function (assert) {
            const x = paper.rect().attr('href', url),
            xAnchor = x.node.parentNode;
            const y = paper.rect().attr('href', url),
            yAnchor = y.node.parentNode;
    ...
    QUnit.test(
        'remove: after added', function (assert) {
            const el = paper.rect(),
            node = el.node;
    ...
    QUnit.test(
        'remove: when wrapped in <a>', function (assert) {
            const el = paper.rect().attr('href', url),
            node = el.node,
    ...
    QUnit.test(
        'remove: when already removed', function (assert) {
            const el = paper.rect(),
            node = el.node;
    ...
    QUnit.test(
        'remove: when the canvas is removed', function (assert) {
            const el = paper.rect(),
            node = el.node;
    ...
    QUnit.test(
        'toFront: normal', function (assert) {
            const el = paper.rect();
            const x = paper.rect();
    ...
    QUnit.test(
        'toFront: when wrapped in <a>', function (assert) {
            const el = paper.rect().attr('href', url),
            anchor = el.node.parentNode;
            const x = paper.rect();
    ...
    QUnit.test(
        'toBack: when wrapped in <a>', function (assert) {
            const x = paper.rect();
            const el = paper.rect().attr('href', url),
            anchor = el.node.parentNode;
