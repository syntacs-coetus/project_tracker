    ...
    ["eve"], function (eve) {
        ...
        function R(first)
        {
            if (R.is(first, "function")) {
                ...
                if (R.is(args[args.length - 1], "function")) {
                    var f = args.pop();
                    return loaded ? f.call(R._engine.create[apply](R, args)) : eve.on(
        ...
        R.parsePathString = function (pathString) {
            ...
            if (!data.length) {
                Str(pathString).replace(
                    pathCommand, function (a, b, c) {
                        var params = [],
                        name = b.toLowerCase();
                        c.replace(
                            pathValues, function (a, b) {
                                b && params.push(+b);
                            }
                        );
            ...
            if (!font.svg) {
                ...
                for (var glyph in font.glyphs) { if (font.glyphs[has](glyph)) {
                        ...
                        fontcopy.glyphs[glyph] = {
                            w: path.w,
                            k: {},
                            d: path.d && "M" + path.d.replace(
                                /[mlcxtrv]/g, function (command) {
        ...
        **
        ...
        R.format = function (token, params) {
            ...
            token && R.is(token, string) && args.length - 1 && (token = token.replace(
                formatrg, function (str, i) {
        ...
        **
        ...
        R.fullfill = (function () {
            ...
            replacer = function (all, key, obj) {
                var res = obj;
                key.replace(
                    objNotationRegex, function (all, name, quote, quotedName, isFunc) {
