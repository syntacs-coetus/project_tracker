        ...
        SmartWizard.prototype, {
            ...
            _setElements: function () {
                ...
                if (this.options.disabledSteps && this.options.disabledSteps.length > 0) {
                    $.each(
                        this.options.disabledSteps, function (i, n) {
                ...
                if (this.options.errorSteps && this.options.errorSteps.length > 0) {
                    $.each(
                        this.options.errorSteps, function (i, n) {
                ...
                if (this.options.hiddenSteps && this.options.hiddenSteps.length > 0) {
                    $.each(
                        this.options.hiddenSteps, function (i, n) {
            ...
            _setToolbar: function () {
                ...
                if (this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0) {
                    ...
                    $.each(
                        this.options.toolbarSettings.toolbarExtraButtons, function (i, n) {
            ...
            _transitPage: function (idx) {
                ...
                if (this.options.transitionEffect === 'slide') {
                    ...
                    if (curPage && curPage.length > 0) {
                        curPage.slideUp(
                            'fast', this.options.transitionEasing, function () {
                    ...
                    if (curPage && curPage.length > 0) {
                        curPage.fadeOut(
                            'fast', this.options.transitionEasing, function () {
                                selPage.fadeIn(
                                    'fast', mi.options.transitionEasing, function () {
                                        $(this).show();
                                    }
                                );
                            }
