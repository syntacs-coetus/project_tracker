describe(
    'SmartWizard Default Options', function () {
        var el, plugin;
        ...
        it(
            'should add default theme to the element', function () {
                expect(el).toHaveClass("sw-theme-default");
            }
        );

        it(
            'should add toolbar elements', function () {
        ...
        it(
            'should have step anchors', function () {
                expect(el.children('ul').children('li').children('a')).toExist();
            }
        );

        it(
            'should have step contents', function () {
                expect(el.children('div').children('div')).toExist();
            }
        );

        it(
            'should have step anchors step contents are equal numbers', function () {
...
describe(
    'SmartWizard Navigation', function () {
        var el, plugin;
        ...
        it(
            'should point to the first step', function () {
