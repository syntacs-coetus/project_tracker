...
+function ($) {
    ...
    var Lightbox = (function () {
        ...
        function Lightbox($element, config)
        {
            ...
            if (this._galleryName) {
                ...
                if (this._config.showArrows && this._$galleryItems.length > 1) {
                    ...
                    this._$lightboxContainer.on(
                        'click', 'a:first-child', function (event) {
                            event.preventDefault();
                            return _this.navigateLeft();
                        }
                    );
                    this._$lightboxContainer.on(
                        'click', 'a:last-child', function (event) {
                            event.preventDefault();
            ...
            this._$modal.on('show.bs.modal', this._config.onShow.bind(this)).on(
                'shown.bs.modal', function () {
                    _this._toggleLoading(true);
                    _this._handle();
                    return _this._config.onShown.call(_this);
                }
            ).on('hide.bs.modal', this._config.onHide.bind(this)).on(
