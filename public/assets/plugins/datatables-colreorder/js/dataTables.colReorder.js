 ...
 *
    ...
    $.fn.dataTableExt.oApi.fnColReorder = function ( oSettings, iFrom, iTo, drop, invalidateRows ) {
        ...
        */
        ...
        $.each(
            oSettings.aLastSort, function (i, val) {
        ...
        ColReorder.prototype, {
            ...
            * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
            ...
            "_fnConstruct": function () {
                ...
                this.s.dt.oApi._fnCallbackReg(
                    this.s.dt, 'aoStateSaveParams', function (oS, oData) {
                ...
                // Destroy clean up
                $(table).on(
                    'destroy.dt.colReorder', function () {
                        $(table).off('destroy.dt.colReorder draw.dt.colReorder');

                        $.each(
                            that.s.dt.aoColumns, function (i, column) {
            ...
            "_fnOrderColumns": function ( a ) {
                ...
                if (a.length != this.s.dt.aoColumns.length ) {
                    this.s.dt.oInstance.oApi._fnLog(
                        this.s.dt, 1, "ColReorder - array reorder does not "+
            ...
            */
            ...
            "_fnMouseListener": function ( i, nTh ) {
                ...
                $(nTh)
                .on(
                    'mousedown.ColReorder', function (e) {
                ...
                .on(
                    'touchstart.ColReorder', function (e) {
                        if (that.s.enable ) {
                               that._fnMouseDown.call(that, e, nTh);
                        }
                    } 
            ...
            "_fnMouseDown": function ( e, nTh ) {
                ...
                $(document)
                .on(
                    'mousemove.ColReorder touchmove.ColReorder', function (e) {
                        that._fnMouseMove.call(that, e);
                    } 
                )
                .on(
                    'mouseup.ColReorder touchend.ColReorder', function (e) {
                ...
                if (this.dom.drag === null ) {
                    ...
                    */
                    if (Math.pow(
                        ...
                        Math.pow(this._fnCursorPosition(e, 'pageY') - this.s.mouse.startY, 2), 0.5 
                    ) < 5 
                    ) {
                           return;
                    }
            ...
            "_fnSetColumnIndexes": function () {
                $.each(
                    this.s.dt.aoColumns, function (i, column) {
 ...
 *
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    $(document).on(
        'preInit.dt.colReorder', function (e, settings) {
            if (e.namespace !== 'dt' ) {
                return;
            }
    ...
    $.fn.dataTable.Api.register(
        'colReorder.order()', function ( set, original ) {
            if (set ) {
                return this.iterator(
                    'table', function ( ctx ) {
    ...
    $.fn.dataTable.Api.register(
        'colReorder.transpose()', function ( idx, dir ) {
    ...
    $.fn.dataTable.Api.register(
        'colReorder.move()', function ( from, to, drop, invalidateRows ) {
    ...
    $.fn.dataTable.Api.register(
        'colReorder.enable()', function ( flag ) {
            return this.iterator(
                'table', function ( ctx ) {
                    if (ctx._colReorder ) {
