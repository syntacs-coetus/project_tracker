...
(function ( factory ) {
            ...
            */
                        ...
                        available, function ( i, name ) {
                            list.append(
                                ...
                                .append(
                                    ...
                                    .append(
                                        $('<button class="'+AutoFill.classes.btn+'">'+dt.i18n('autoFill.button', '&gt;')+'</button>')
                                        .on(
                                            'click', function () {
            ...
            _focusListener: function () {
                ...
                if (focus === 'focus' ) {
                    dt
                    .on(
                        'key-focus.autoFill', function ( e, dt, cell ) {
                            that._attach(cell.node());
                        } 
                    )
                    .on(
                        'key-blur.autoFill', function ( e, dt, cell ) {
                            that._detach();
                        } 
                    );
                }
                    ...
                    $(dt.table().body()).on(
                        'click'+namespace, 'td, th', function (e) {
                            that._attach(this);
                        } 
                    );
                    ...
                    $(dt.table().body())
                    .on(
                        'mouseenter'+namespace, 'td, th', function (e) {
                            that._attach(this);
                        } 
                    )
                    .on(
                        'mouseleave'+namespace, function (e) {
            ...
            _mousedown: function ( e ) {
                ...
                $(document.body)
                .on(
                    'mousemove.autoFill', function (e) {
                        that._mousemove(e);
                    } 
                )
                .on(
                    'mouseup.autoFill', function (e) {
                        that._mouseup(e);
                    } 
                );
            ...
            _mouseup: function ( e ) {
                ...
                if ($('div.DTE', startDt.node()).length ) {
                    ...
                    editor
                    .on(
                        'submitSuccess.dtaf close.dtaf', function () {
                            editor.off('.dtaf');
                    ...
                    .on(
                        'submitComplete.dtaf preSubmitCancelled.dtaf close.dtaf', function () {
                            editor.off('.dtaf');
                        } 
                    );
            ...
            _shiftScroll: function ( e ) {
                ...
                if (! this.s.scrollInterval && runInterval ) {
                    this.s.scrollInterval = setInterval(
                        function () {
    ...
    */
    ...
    $(document).on(
        'preInit.dt.autofill', function (e, settings, json) {
            if (e.namespace !== 'dt' ) {
                return;
            }
