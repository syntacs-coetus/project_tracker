...
*/ (function () {
    function OffsetTracker(el)
    {
        ...
        this.scrollCaches = core.getClippingParents(el).map(
            function (el) {
                    ...
                    if (validMutation) {
                        ...
                        if (receivingCalendar === initialCalendar_1) {
                            ...
                            var eventDropArg = __assign(
                                {}, transformed, { el: ev.subjectEl, delta: validMutation.datesDelta, oldEvent: eventApi, event: new core.EventApi(// the data AFTER the mutation
