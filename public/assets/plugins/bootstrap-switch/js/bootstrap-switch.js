...
(function (global, factory) {
    ...
    this, function (_jquery) {
        ...
        function getClasses(options, id)
        {
            ...
            return [state ? 'on' : 'off', size, disabled ? 'disabled' : undefined, readonly ? 'readonly' : undefined, indeterminate ? 'indeterminate' : undefined, inverse ? 'inverse' : undefined, id ? 'id-' + id : undefined].filter(
                function (v) {
                    return v == null;
                }
            );
        ...
        function prvhandleHandlers()
        {
            ...
            this.$on.on(
                'click.bootstrapSwitch', function (event) {
                    event.preventDefault();
        ...
        function prvformHandler()
        {
            ...
            $form.on(
                'reset.bootstrapSwitch', function () {
                    window.setTimeout(
                        function () {
            ...
            function BootstrapSwitch(element)
            {
                ...
                this.$wrapper = $(
                    '<div>', {
                        ...
                        {
                            return getClasses(_this9.options, _this9.$element.attr('id')).map(
                                function (v) {
