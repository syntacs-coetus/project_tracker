...
(function ( factory ) {
    if (typeof define === 'function' && define.amd ) {
        // AMD
        define(
            ['jquery', 'datatables.net', 'datatables.net-buttons'], function ( $ ) {
    ...
    ZeroClipboard_TableTools.Client.prototype = {
        ...
        destroy: function () {
            ...
            if (this.domElement && this.div) {
                ...
                $.each(
                    ZeroClipboard_TableTools.clients, function ( id, client ) {
                        if (client === that ) {
    ...
    */
    ...
    function _createNode( doc, nodeName, opts )
    {
        ...
        if (opts ) {
            ...
            if (opts.children ) {
                $.each(
                    opts.children, function ( key, value ) {
    ...
    */
    ...
    DataTable.Api.register(
        'buttons.resize()', function () {
            $.each(
                ZeroClipboard_TableTools.clients, function ( i, client ) {
