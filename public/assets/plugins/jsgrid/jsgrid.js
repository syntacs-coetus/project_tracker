...
(function (window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        _eachField: function (callBack) {
            var self = this;
            $.each(
                this.fields, function (index, field) {
                    if(field.visible) {
        ...
        _createNoDataRow: function () {
            ...
            return $("<tr>").addClass(this.noDataRowClass)
                .append(
                    $("<td>").addClass(this.cellClass).attr("colspan", amountOfFields)
        ...
        _createPagerNavButton: function (text, pageIndex, isActive) {
            return this._createPagerButton(
                text, this.pagerNavButtonClass + (isActive ? "" : " " + this.pagerNavButtonInactiveClass),
                isActive ? function () {
                    this.openPage(pageIndex); } : $.noop
            );
        },
        ...
        _createPagerPage: function (pageIndex) {
            return this._createPagerButton(
                pageIndex, this.pageClass, function () {
    ...
    _refreshHeight: function () {
        ...
        loadData: function (filter) {
            ...
            var args = this._callEventHandler(
                this.onDataLoading, {
                    filter: filter
                }
            );
            ...
            return this._controllerCall(
                "loadData", filter, args.cancel, function (loadedData) {
                    if(!loadedData) {
                        return;
                    }
        ...
        insertItem: function (item) {
            ...
            var args = this._callEventHandler(
                this.onItemInserting, {
                    item: insertingItem
                }
            );

            return this._controllerCall(
                "insertItem", insertingItem, args.cancel, function (insertedItem) {
        ...
        rowByItem: function (item) {
            ...
            return this._content.find("tr").filter(
                function () {
        ...
        _updateRow: function ($updatingRow, editedItem) {
            ...
            return this._controllerCall(
                "updateItem", updatedItem, args.cancel, function (loadedUpdatedItem) {
        ...
        _deleteRow: function ($row) {
            ...
            return this._controllerCall(
                "deleteItem", deletingItem, args.cancel, function () {
    ...
    var setLocale = function (obj, localeConfig) {
        $.each(
            localeConfig, function (field, value) {
...
(function (jsGrid, $, undefined) {
    ...
    Validation.prototype = {
        ...
        validate: function (args) {
            ...
            $.each(
                this._normalizeRules(args.rules), function (_, rule) {
    ...
    SelectField.prototype = new NumberField(
        {
            ...
            _createSelect: function () {
                ...
                $.each(
                    this.items, function (index, item) {
    ...
    ControlField.prototype = new Field(
        {
            ...
            _createOnOffSwitchButton: function (option, cssClass, isOnInitially) {
                ...
                var $button = this._createGridButton(
                    this.modeButtonClass + " " + cssClass, "", function (grid) {
                        isOn = !isOn;
            ...
            _createModeSwitchButton: function () {
                ...
                var $button = this._createGridButton(
                    this.modeButtonClass, "", function (grid) {
            ...
            _createEditButton: function (item) {
                return this._createGridButton(
                    this.editButtonClass, this.editButtonTooltip, function (grid, e) {
                        grid.editItem(item);
                        e.stopPropagation();
                    }
                );
            ...
            _createDeleteButton: function (item) {
                return this._createGridButton(
                    this.deleteButtonClass, this.deleteButtonTooltip, function (grid, e) {
            ...
            _createSearchButton: function () {
                return this._createGridButton(
                    this.searchButtonClass, this.searchButtonTooltip, function (grid) {
                        grid.search();
                    }
                );
            },
            ...
            _createClearFilterButton: function () {
                return this._createGridButton(
                    this.clearFilterButtonClass, this.clearFilterButtonTooltip, function (grid) {
                        grid.clearFilter();
                    }
                );
            },
            ...
            _createInsertButton: function () {
                return this._createGridButton(
                    this.insertButtonClass, this.insertButtonTooltip, function (grid) {
                        grid.insertItem().done(
                            function () {
                                grid.clearInsert();
                            }
                        );
            ...
            _createUpdateButton: function () {
                return this._createGridButton(
                    this.updateButtonClass, this.updateButtonTooltip, function (grid, e) {
                        grid.updateItem();
                        e.stopPropagation();
                    }
                );
            ...
            _createCancelEditButton: function () {
                return this._createGridButton(
                    this.cancelEditButtonClass, this.cancelEditButtonTooltip, function (grid, e) {
                        grid.cancelEdit();
                        e.stopPropagation();
                    }
                );
